...
namespace lab_67_MVC_Website_Football.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OwnerID,OwnerName,NetWorth")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OwnerID,OwnerName,NetWorth")] Owner owner)
        {
            if (id != owner.OwnerID)
            {
                return NotFound();
